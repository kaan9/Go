 ...
 */
public class GameBoard extends GameObj {
    public static final String IMG_FILE = "files/gameBoard.png";
    public static final int SIZE = 303;// 441;//302;
    public static final int INIT_POS_X = 6;
    public static final int INIT_POS_Y = 6;

    private static BufferedImage img;

    public GameBoard(int courtWidth, int courtHeight) {
